...
simIn = simIn.setVariable('cfg_fault_id', current_fault_id, 'Workspace', model_name);
simIn = simIn.setVariable('cfg_start', current_start, 'Workspace', model_name);
simIn = simIn.setVariable('cfg_duration', current_duration, 'Workspace', model_name);
